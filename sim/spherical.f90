!Uses a spherical cutoff for both real space and reciprocal space when creating 
!the dipole matrix
...
double precision, parameter :: T=0,Hmax1=0,Hmin1=0,CON=0.000000001
...
write(*,*) hmag,E/nocc,mav
write(1,999) hmag,EAV/nocc,mav,chi,Cvt
!write(2,999) hmag,mxav,myav,mzav
write(3,999) hmag,hmx,hmy,hmz
